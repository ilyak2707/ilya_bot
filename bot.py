...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    welcome_text = dedent(
        """
        👋 Привет! Помогу проверить юр-безопасность бизнеса. Нажмите ниже, чтобы получить чек-лист из 15 пунктов.
...
async def show_policy(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    policy_text = dedent(
        """
        ℹ️ Политика обработки персональных данных (версия v1-2025-09-24)

        1. Общие положения. Настоящая политика определяет порядок обработки и защиты персональных данных пользователей Telegram-бота «Юр-безопасность бизнеса» (далее — Бот) и составлена в соответствии с требованиями законодательства Российской Федерации о персональных данных.

        2. Термины и определения. Используемые в политике термины трактуются в соответствии с Федеральным законом № 152-ФЗ «О персональных данных». Субъект персональных данных — пользователь, взаимодействующий с Ботом; Оператор — лицо, самостоятельно или совместно с другими лицами организующее и (или) осуществляющее обработку персональных данных.

        3. Оператор и контактные данные. Оператором является Индивидуальный предприниматель Иванов Илья Сергеевич, ИНН 780166767877. Для вопросов обработки персональных данных вы можете обратиться по адресу электронной почты privacy@legal-safe.ru или направить запрос через команду /revoke.

        4. Обрабатываемые персональные данные. Оператор обрабатывает следующие сведения: фамилия и имя, заявленный статус (роль) пользователя, номер телефона, идентификатор и username в Telegram, а также сведения, предоставленные добровольно в процессе переписки.

        5. Цели обработки персональных данных. Данные используются для: предоставления чек-листа по юридической безопасности бизнеса; обратной связи по запросам пользователя; информирования о продуктах, услугах и мероприятиях Оператора; ведения статистики и аналитики использования Бота.

        6. Правовые основания обработки. Обработка осуществляется на основании Федерального закона № 152-ФЗ «О персональных данных», Федерального закона № 38-ФЗ «О рекламе», а также согласия субъекта персональных данных, выраженного посредством функционала Бота.

        7. Порядок и условия обработки. Оператор осуществляет сбор, запись, систематизацию, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, передачу (распространение, предоставление, доступ), обезличивание, блокирование, удаление и уничтожение персональных данных с соблюдением принципов и правил, предусмотренных законодательством.

        8. Хранение и защита персональных данных. Данные хранятся в электронном виде в информационных системах Оператора на территории Российской Федерации. Применяются необходимые правовые, организационные и технические меры для защиты данных от неправомерного или случайного доступа, уничтожения, изменения, блокирования, копирования, предоставления, распространения и иных неправомерных действий.

        9. Передача третьим лицам. Передача данных третьим лицам осуществляется только при наличии законных оснований, в пределах целей обработки и при условии соблюдения конфиденциальности. При привлечении сервисов рассылок и иных подрядчиков Оператор обеспечивает заключение необходимых договоров и передачу только минимального объема данных.

        10. Сроки обработки. Персональные данные обрабатываются до достижения целей обработки либо до отзыва согласия субъектом персональных данных. После достижения целей или получения отзыва данные подлежат удалению или обезличиванию, если иное не предусмотрено законодательством.

        11. Права субъекта персональных данных. Пользователь вправе получить сведения об обработке своих данных, требовать их уточнения, блокирования или уничтожения, отзывать согласие, а также обжаловать действия Оператора. Для реализации прав направьте запрос на privacy@legal-safe.ru или воспользуйтесь командой /revoke.
        """
    ).strip()
...
async def ask_consent(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    consent_text = dedent(
        ...
        Оператор: Индивидуальный предприниматель Иванов Илья Сергеевич, ИНН 000000000000, адрес: 109012, г. Москва, ул. Примерная, д. 1, офис 2. Контактный e-mail: privacy@example.ru.

        Перечень данных: фамилия, имя, статус (роль при обращении), номер телефона, идентификатор и username в Telegram.

        Цели обработки: отправка чек-листа, обратная связь по запросу и информирование о продуктах и услугах оператора.

        Действия с данными: сбор, запись, систематизация, накопление, хранение, уточнение, использование, передача (в том числе с использованием сервисов рассылок на территории РФ), обезличивание и уничтожение.

        Срок обработки: до достижения указанных целей или до отзыва согласия. Отозвать согласие можно по e-mail privacy@example.ru или командой /revoke. Политика обработки персональных данных: /policy.

        Подтвердите своё решение. Версия согласия: v1-2025-09-24.
        """
    ).strip()
